...
private[mpi] trait Manager:
  ...
  def addNode[F[_]: Async](data: NodeData): F[MnId]
  ...
  // Used mainly for testing and debugging.
  def upsertNodesByName[F[_]: Async](data: NodeData): F[MnId]
  ...
  // Used mainly for testing and debugging.
  def addEdge[F[_]: Async](key: MeKey, sampleIds: Set[SampleId]): F[MeKey]
